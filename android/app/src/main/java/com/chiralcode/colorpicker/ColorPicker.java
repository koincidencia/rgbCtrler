...
import com.rgbctrler.rgbctrler.ColorPickingActivity;

public class ColorPicker extends View {

    //KAZYMOD:
    public interface OnTouchEventIface{
        public void customOnTouchEvent();
    }
    private OnTouchEventIface onTouchEventIface;

    public void setOnTouchEventIface(OnTouchEventIface iface){
        this.onTouchEventIface = iface;
    }
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        if(onTouchEventIface != null){
            onTouchEventIface.customOnTouchEvent();
        }
